...
mongo_uri = "mongodb://admin:password@mongo_dockerizado:27017/?authSource=admin"
...
consumer = KafkaConsumer(
    ...
    bootstrap_servers='kafka:9092',  # Nombre del servicio Kafka + puerto
    auto_offset_reset='earliest',    # O 'latest'
    enable_auto_commit=True,
    #group_id='mi-grupo-consumidor',
    api_version=(0,10)
)
...
def classify_flight_delays_realtime_response(unique_id):
  ...
  while time.time() - start_time < timeout_seconds:
    # Poll para recibir mensajes; ajusta el timeout_ms según tus necesidades
